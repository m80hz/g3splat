...
# Cross-Domain Zero-shot Depth Evaluation on ScanNetV1 (the newly trained models)
...
# Cross-Domain Zero-shot Pose Evaluation on ScanNetV1 (the newly trained models)

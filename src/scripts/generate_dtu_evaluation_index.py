''' Build upon: 
    https://github.com/donydchen/mvsplat/blob/main/src/scripts/generate_dtu_evaluation_index.py
    https://github.com/autonomousvision/murf/blob/main/datasets/dtu.py 
'''
...
def main(args):
    ...
    with open(out_path, "w") as f:
        json.dump(
            {k: None if v is None else asdict(v) for k, v in index.items()}, f, indent=4
        )
